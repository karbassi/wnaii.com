function addListener(e,n,t){e.addEventListener?e.addEventListener(n,t):e.attachEvent&&e.attachEvent("on"+n,t)}var TIMEOUT_TIME=1e3,map,geocoder,timeoutPID,inputElement,canvasElement,answerElement,marker,RESET_TITLE,RESET_CENTER,RESET_ZOOM,FOUND_ZOOM,RESET_NOT_FOUND="No <b>neighborhood</b> found.",initialize=function(){google.maps.visualRefresh=true;RESET_TITLE=document.title,RESET_CENTER=new google.maps.LatLng(41.875696,-87.624207),RESET_ZOOM=12,FOUND_ZOOM=15,canvasElement=document.getElementsByTagName("div")[0],navigator.geolocation.getCurrentPosition(function(e){initialLocation=new google.maps.LatLng(e.coords.latitude,e.coords.longitude),searchLocation(initialLocation),ga("send","event","result","auto")},function(){inputElement.className="invalid",resetMap(RESET_NOT_FOUND)})
...
var n=function(){a(this.value,!1)},t=function(e){return a(this.value,!0),ga("send","event","form",e.type),e.preventDefault(),!1},a=function(e,n){window.clearTimeout(timeoutPID),resetMap("Searching..."),timeoutPID=window.setTimeout(function(){searchLocation(e,n)},TIMEOUT_TIME)},o=document.getElementsByTagName("form")[0]
...
null!=marker&&(e=marker.position,n=FOUND_ZOOM),map.setCenter(e),map.setZoom(n)},searchLocation=function(e,n){if(0===e.length)return resetMap(),void 0
...
ga("send","event","country",i),ga("send","event","state",s),ga("send","event","neighborhood",r),map.setZoom(FOUND_ZOOM),map.setCenter(o.geometry.location),null==marker?marker=new google.maps.Marker({map:map,position:o.geometry.location}):marker.setPosition(o.geometry.location),updateNeighborhood(r),n&&(inputElement.value=o.formatted_address)},o={address:e}
